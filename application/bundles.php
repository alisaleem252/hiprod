...
return array(
    ...
    'admin' => array(
        ...
        'autoloads' => array(
            'map' => array(
                ...
                'Admin_Base_Ajax_Controller'    => '(:bundle)/controllers/base/ajax.php'
            )
        ),
    ),
    ...
    'asi'   => array(
        ...
        'auto'      => true,
        'autoloads' => array(
            'map' => array('Asi_Base_Controller' => '(:bundle)/controllers/base.php')   
        ),
    ),
    
    // Bootstrapper (Twitter Bootstrap)
    'bootstrapper' => array('auto' => true),
    
    // Docs (Disabled unless needed
